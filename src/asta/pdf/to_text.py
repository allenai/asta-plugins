...
def to_text(
    ...
    try:
        ...
        if output_format == "markdown":
            ...
            # For JSON, we need to use LlamaIndex format which returns structured data
            result_data = pymupdf4llm.to_markdown(
                doc,
                pages=page_list,
            ...
            if isinstance(result_data, list):
                # Page chunks mode returns list of dicts
            ...
            # For plain text, extract without markdown formatting
            result = []
