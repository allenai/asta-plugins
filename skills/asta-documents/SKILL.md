...
- Manual install: `uv tool install git+ssh://git@github.com/allenai/asta-resource-repo.git`
...
```bash
uv tool install --reinstall git+ssh://git@github.com/allenai/asta-resource-repo.git
```
